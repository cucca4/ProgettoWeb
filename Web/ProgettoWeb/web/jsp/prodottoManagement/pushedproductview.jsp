...
<%
    ...
    PushedProduct product = (PushedProduct) request.getAttribute("product");
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark clearfix">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <% if(!loggedOn) {%>     
                ...
                <input type="hidden" name="model" value="<%=product.getProd_Id() %>">
                <input type="hidden" name="controllerAction" value="PushedProductManagement.logon">
                </form>
            <%} else {%>
                ...
                <input type="hidden" name="model" value="<%=product.getProd_Id()%>">
                <input type="hidden" name="controllerAction" value="PushedProductManagement.logout">
                </form>
             <%}%>
